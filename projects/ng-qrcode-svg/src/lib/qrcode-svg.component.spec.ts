...
describe('QrcodeSvgComponent', () => {
  describe('Rendering', () => {
    ...
    it('should fully render the QR code', async () => {
      ...
      expect(svg.query(By.css('path')).nativeElement.getAttribute('d').startsWith('M04,04h1v1h-1z')).toBeTrue();
  ...
  describe('Tests', () => {
    ...
    it('should skip update if backgroundColor changed', () => {
      ...
      const changes: SimpleChanges = {
        backgroundColor: {
          ...
          currentValue: '#FF0000',
          previousValue: component.backgroundColor
        }
      };
    ...
    it('should NOT skip update if backgroundColor changed for first time', () => {
      component.value = 'value';
      ...
      expect(component.d).toBeDefined();
    });

    it('should skip update if foregroundColor changed', () => {
      component.value = 'value';
      ...
      const changes: SimpleChanges = {
        foregroundColor: {
          ...
          isFirstChange: () => firstChange,
          currentValue: '#FF0000',
          previousValue: component.foregroundColor
        }
      };
    ...
    it('should NOT skip update if foregroundColor changed for first time', () => {
      component.value = 'value';
    ...
    it('should skip update if size changed', () => {
      component.value = 'value';
    ...
    it('should NOT skip update if size changed for first time', () => {
      component.value = 'value';
    ...
    it('should throw error if value is missing', () => {
      ...
      expect(() => component.ngOnChanges({})).toThrow(Error('[@larscom/ng-qrcode-svg] You must provide a value!'));
    });
    ...
    it(`should throw error if foregroundColor doesn't match hex pattern`, () => {
      ...
      expect(() => component.ngOnChanges({})).toThrow(
        Error('[@larscom/ng-qrcode-svg] You must provide a valid foregroundColor (HEX RGB) eg: #000000')
      );
    });
    ...
    it(`should throw error if backgroundColor doesn't match hex pattern`, () => {
      ...
      expect(() => component.ngOnChanges({})).toThrow(
        Error('[@larscom/ng-qrcode-svg] You must provide a valid backgroundColor (HEX RGB) eg: #FFFFFF')
      );
    });
  });
});
